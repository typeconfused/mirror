...
|-----------|-------------|
| [13660.txt](13660.txt) | Exploitation With WriteProcessMemory() Yet Another DEP Trick - Written By Spencer Pratt |
...
| [Aaron_Portnoy-Bypassing_All_Of_The_Things.pdf](Aaron_Portnoy-Bypassing_All_Of_The_Things.pdf) | Bypass All of the Things - Aaron Portnoy |
...
| [DEF CON 15 - kernel_wars.pdf](DEF%20CON%2015%20-%20kernel_wars.pdf) | Kernel Wars: Kernel-exploitation demystified DEF CON 15 |
| [DEF CON 25 - Morten-Schenk-Taking-Windows-10-Kernel-Exploitation-to-the-next-level-UPDATED.pdf](DEF%20CON%2025%20-%20Morten-Schenk-Taking-Windows-10-Kernel-Exploitation-to-the-next-level-UPDATED.pdf) | Taking Windows 10 Kernel exploitation to the next level - leveraging write-what-where vulnerabilities in creators update - Morten Schenk DEF CON 25 |
...
| [HARES-WP.pdf](HARES-WP.pdf) | HARES: Hardened Anti-Reverse Engineering System |
...
| [safe_unlinking_and_reference_count_hardening.pdf](safe_unlinking_and_reference_count_hardening.pdf) | Software defense: safe unlinking and reference count hardening (MSRC) |
...
| [Windows_81_Kernel_Patch_Protection_Analysis.pdf](Windows_81_Kernel_Patch_Protection_Analysis.pdf) | Windows 8.1 kernel patch protection analysis - Positive Technologies |
| [abusing_token_eop_1.0.txt](abusing_token_eop_1.0.txt) | Abusing Token Privileges For LPE - drone and breenmachine |
| [bh-eu-07-eriksson-WP.pdf](bh-eu-07-eriksson-WP.pdf) | FreeBSD 802.11 Remote Integer Overflow - BH2007 whitepaper Karl Janmar |
| [bh-eu-07-eriksson.pdf](bh-eu-07-eriksson.pdf) | Kernel Wars: Kernel-exploitation demystified - BH Europe |
| [bh-usa-07-eriksson_oberg_nyberg_and_jammar.pdf](bh-usa-07-eriksson_oberg_nyberg_and_jammar.pdf) | Kernel Wars: Kernel-exploitation demystified - BH USA |
| [bh-win-04-fx.pdf](bh-win-04-fx.pdf) | Practical Win32 and UNICODE exploitation - FX |
| [binding-the-daemon-wp.pdf](binding-the-daemon-wp.pdf) | Binding the Daemon: FreeBSD Kernel Stack and Heap Exploitation |
| [bypassing-x64-patchguard.pdf](bypassing-x64-patchguard.pdf) | Bypassing PatchGuard on Windows x64 - skape and skywing |
| [cve_2018_8611_windows_ktm_exploitation_poc2019.pdf](cve_2018_8611_windows_ktm_exploitation_poc2019.pdf) | Exploiting CVE-2018-8611 Windows Kernel Transaction Manager (KTM) Race Condition Aaron Adams and Cedric Halbronn - Power Of Community 2019 |
| [depevasion.pdf](depevasion.pdf) | A DEP evasion technique |
| [dimva_paper2.pdf](dimva_paper2.pdf) | Structural Comparion of Executable Objects - Halvar Flake |
| [egghunt-shellcode.pdf](egghunt-shellcode.pdf) | Safely Searching Process Virtual Address Space - skape |
| [formatstring-1.2.pdf](formatstring-1.2.pdf) | Exploiting Format string vulnerabilities - scut team teso |
| [geometry.pdf](geometry.pdf) | The geometry of Innocent Flesh and Bone: Return-into-libc without function calls (on the x86) |
| [infiltrate2015.pdf](infiltrate2015.pdf) | Insection Awesomely exploiting shared memory objects - Alex Ionescu - Infiltrate |
...
| [uroburos.pdf](uroburos.pdf) | Uroburos: the snake rootkit |
| [us-16-Branco-DPTrace-Dual-Purpose-Trace-For-Exploitability-Analysis-Of-Program-Crashes-wp.pdf](us-16-Branco-DPTrace-Dual-Purpose-Trace-For-Exploitability-Analysis-Of-Program-Crashes-wp.pdf) | DPTrace dual purpose trace for exploitability analysis of program crashes |
| [us-17-Schenk-Taking-Windows-10-Kernel-Exploitation-To-The-Next-Level–Leveraging-Write-What-Where-Vulnerabilities-In-Creators-Update-wp.pdf](us-17-Schenk-Taking-Windows-10-Kernel-Exploitation-To-The-Next-Level%E2%80%93Leveraging-Write-What-Where-Vulnerabilities-In-Creators-Update-wp.pdf) | Taking Windows 10 Kernel Exploitation to the next level - leveraging write-what-where vulnerabilities in creators update - Morten Schenk |
| [us-17-Schenk-Taking-Windows-10-Kernel-Exploitation-To-The-Next-Level–Leveraging-Write-What-Where-Vulnerabilities-In-Creators-Update.pdf](us-17-Schenk-Taking-Windows-10-Kernel-Exploitation-To-The-Next-Level%E2%80%93Leveraging-Write-What-Where-Vulnerabilities-In-Creators-Update.pdf) | Taking Windows 10 Kernel Exploitation to the next level - leveraging write-what-where vulnerabilities in creators update - Morten Schenk - presentation |
